...
public class AuxiliarFichas {
	...
	public int voltearFichasOpuestas(Ficha f, int fila, int col) {
		...
		darVueltaAFichas(f, coordenadasFichas);
		return coordenadasFichas.size();
	}

	public int voltearFichasOpuestas(Ficha f, Coordenadas c) {
		return voltearFichasOpuestas(f, c.getFila(), c.getColumna());
	}
	...
	//Reemplaza las fichas que se encuentran en las coordenadas obtenidas por la ficha recibida
